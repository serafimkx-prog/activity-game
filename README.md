...
Верхние три словаря в сетке открыты сразу, нижние три открываются после входа в аккаунт.
...
- Верхний ряд словарей открыт без входа.
- Нижний ряд словарей открывается бесплатно после входа через Telegram.
